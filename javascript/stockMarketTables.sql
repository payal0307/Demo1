...
insert into Orders values( 1, 1, 'sell', 102.00, 10, getdate());
insert into Orders values( 2, 1, 'sell', 102.00, 10, getdate());
drop table Orders
...
insert into TradeExecution values( 1, 2, 103.75, 5,getdate())


select * from PriceHistory
select * from TradeExecution
select * from Orders
